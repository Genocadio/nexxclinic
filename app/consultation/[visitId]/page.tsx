...
export default function ConsultationPage() {
  ...
  const { notes: departmentNotes, refetch: refetchNotes } = useVisitDepartmentNotes(
    visitId,
    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <div className="max-w-5xl mx-auto px-6 py-8 space-y-4">
          ...
          {[...Array(3)].map((_, idx) => (
            <div key={idx} className="bg-card/70 border rounded-2xl p-4 space-y-3">
    ...
    <div className="min-h-screen bg-background">
      ...
      <VisitNotesFloating
        ...
        onAddNote={async (noteType, content) => {
          ...
          if (!visitDepartmentId) throw new Error('No department selected for consultation note')
